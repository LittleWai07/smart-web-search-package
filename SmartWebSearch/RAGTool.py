...
class _KnowledgeBase:
    ...
    def match_knowledge(self, embedding_model: SentenceTransformer, prompt: str, top_k: int = 10, threshold_score: float = 0.65):
        """
        ...
        Args:
            ...
            threshold_score (float) = 0.65: The threshold score for a match.
...
class RAGTool:
    ...
    def __build_knowledge_base(text_data: str, embedding_model: SentenceTransformer, text_splitter: RecursiveCharacterTextSplitter) -> _KnowledgeBaseSet:
        ...
        # Seperate the chunks into several chunk sets every 15 chunks
        chunk_sets: list[list[str]] = [chunks[i: i + 15] for i in range(0, len(chunks), 15)]
    ...
    def __init__(self, embedding_model_name: str = 'Qwen/Qwen3-Embedding-0.6B') -> None:
        """
        Initialize the RAGTool object.
        
        Args:
            embedding_model_name (str) = 'Qwen/Qwen3-Embedding-0.6B': The name of the embedding model.
    ...
    def match_knowledge(self, knowledge_base: _KnowledgeBase | _KnowledgeBaseSet, prompt: str, top_k: int = 10, threshold_score: float = 0.65) -> list[tuple[float, str]]:
        """
        Match the prompt with the knowledge base.
        ...
        Args:
            ...
            prompt (str): The prompt to be matched.
            top_k (int) = 10: The number of top matches to return.
            threshold_score (float) = 0.65: The threshold score for the top matches.
